...
class _Scripts extends HTMLElement{
    ...
    constructor() {
        ...
        <service-section src="${md4tex}" color="dark">
            ...
            <div>
                <a href="https://github.com/mu2chn/md4latex"><i class="fab fa-github-alt fa-2x"></i></a>
            </div>
        </service-section>
        ...
        <div>
            <a href="https://github.com/mu2chn/clipanda"><i class="fab fa-github-alt has-text-dark fa-2x"></i></a>
        </div>
        </service-section>
        `
    }
